...
setallUsers([...allUsers, {userName ,userMail, userPass}])
setuserMail('')
setuserPass('')
setuserName(' ')
  ...
  return (
    <div className="h-[550px] w-[330px] bg-[url('https://i.pinimg.com/736x/3d/d1/a7/3dd1a7caddcf180e6990eed5dec3511e.jpg')] bg-cover bg-center rounded-2xl p-4 flex flex-col items-center gap-2">
     <div className='flex flex-col items-center px-3.5 py-6'>
      ...
      <p className='text-[14px] text-gray-300'>Create your Own itenerary!</p>
     </div>
...
submitHandle(e)
  ...
  <div className="flex items-center gap-5 border-b-2  border-amber-600">
        <UserRound size={22} className="text-amber-600" />
 ...
 /> 
      ...
      <button className='bg-amber-600 w-full ml-5.5 mr-7 p-2.5 mt-8 rounded-xl active:scale-90' >Sign up</button>
     </form>
